...
const OfferPaymentPlansComparator = ({ offerId, plans, listPrice }: Props) => {
  ...
  return (
    <SectionCard icon={BadgePercent} title="Esquemas de financiamiento" bodyClassName="p-5 md:p-6">
        ...
        {plans.map((plan) => {
          ...
          return (
            <button
              ...
              className={`flex-shrink-0 inline-flex flex-col items-center justify-center gap-0.5 px-4 rounded-md text-sm font-medium transition-all border ${
                plan.isPersonalized
                  ? isActive
      ...
      <div className="mt-5 rounded-md border border-border bg-background p-5 md:p-6 space-y-6">
        ...
        <div>
          ...
          />
          {selectedPlan.discountAmount > 0 && (
            <div className="mt-3 flex items-center justify-between gap-3 p-3 rounded-md bg-success/10 border border-success/20">
              <div className="flex items-center gap-3 min-w-0">
