      ...
      <div className="p-5 md:p-6">
        ...
        <div className="mt-5 grid grid-cols-3 gap-2">
          <a
            ...
            className="inline-flex items-center justify-center gap-1.5 h-11 rounded-lg bg-success text-success-foreground text-xs font-semibold hover:bg-success/90 transition-colors"
          >
          ...
          <a
            ...
            className="inline-flex items-center justify-center gap-1.5 h-11 rounded-lg border border-border text-xs font-semibold hover:bg-muted transition-colors"
          >
