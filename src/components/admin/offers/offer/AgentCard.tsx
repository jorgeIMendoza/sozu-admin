...
const AgentCard = ({ agent, offerId, offerLabel }: Props) => {
  ...
  return (
    <div className="rounded-2xl border border-border bg-card overflow-hidden">
      <div className="bg-success/10 border-b border-success/20 px-5 py-2">
      ...
      <div className="p-5 md:p-6">
        ...
        {/* Bio */}
        {agent.bio && (
          <p className="mt-5 text-sm italic text-muted-foreground leading-relaxed border-l-2 border-success/40 pl-3">
            "{agent.bio}"
          </p>
        )}
        ...
        <div className="mt-5 grid grid-cols-3 gap-2">
          <a
            ...
            className="inline-flex items-center justify-center gap-1.5 h-10 rounded-lg bg-success text-success-foreground text-xs font-semibold hover:bg-success/90 transition-colors"
          >
          ...
          <a
            ...
            className="inline-flex items-center justify-center gap-1.5 h-10 rounded-lg border border-border text-xs font-semibold hover:bg-muted transition-colors"
          >
