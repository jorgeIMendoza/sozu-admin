import { filterPortfolioByCategory, getPortfolioTotals } from "@/lib/portal-cliente/mock-data";
import type { InvestmentProperty } from "@/lib/portal-cliente/types";
import { TrendingUp } from "lucide-react";

interface HeroFinancialSummaryProps {
...
const HeroFinancialSummary = ({ portfolio }: HeroFinancialSummaryProps) => {
        ...
        <div className="grid grid-cols-1 lg:grid-cols-12 gap-6 lg:gap-8">
          ...
          <div className="lg:col-span-7">
            ...
            <p className="mt-3 text-[12px] text-muted-foreground">
              {totals.count} propiedad{totals.count !== 1 ? "es" : ""} activa{totals.count !== 1 ? "s" : ""}
            </p>

            {/* Category breakdown */}
            {(() => {
              const inAcq = filterPortfolioByCategory(portfolio, "in_acquisition");
              const patrimony = filterPortfolioByCategory(portfolio, "active_patrimony");
