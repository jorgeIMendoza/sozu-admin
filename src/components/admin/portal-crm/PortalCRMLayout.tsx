...
const navGroups: NavGroup[] = [
  ...
  },
  {
    label: "Dirección",
    items: [
      { label: "Panel ejecutivo",    path: "/admin/portal-crm/executive/dashboard",     icon: LayoutDashboard },
      { label: "Cola de decisiones", path: "/admin/portal-crm/executive/decision-queue", icon: Activity },
      { label: "Resumen semanal",    path: "/admin/portal-crm/executive/weekly-digest",  icon: Sparkles },
    ],
  },
  {
    label: "CRM",
    items: [
      ...
      { label: "Desempeño de asesores",   path: "/admin/portal-crm/crm/agent-performance", icon: UserCheck },
      { label: "Inteligencia de leads",   path: "/admin/portal-crm/crm/lead-intelligence", icon: Sparkles },
      { label: "Asignación de leads",     path: "/admin/portal-crm/crm/routing",           icon: RouteIcon },
      { label: "Operación comercial",     path: "/admin/portal-crm/crm/sales-operations",  icon: BarChart3 },
      { label: "Reglas de automatización", path: "/admin/portal-crm/crm/automation-rules", icon: Cog },
  ...
  },
  {
    ...
    items: [
      { label: "Resumen de desempeño", path: "/admin/portal-crm/marketing/performance",      icon: Activity },
      { label: "Atribución",           path: "/admin/portal-crm/marketing/attribution",      icon: GitBranch },
      { label: "Explorador de campañas", path: "/admin/portal-crm/marketing/campaigns",      icon: Megaphone },
      { label: "Creativos",            path: "/admin/portal-crm/marketing/creatives",        icon: ImageIcon },
      ...
      { label: "Por desarrollo",       path: "/admin/portal-crm/marketing/developments",     icon: Building2 },
      { label: "Embudo Mkt → CRM",     path: "/admin/portal-crm/marketing/funnel",           icon: Activity },
      { label: "Mapeo de campañas",    path: "/admin/portal-crm/marketing/campaign-mapping", icon: Megaphone },
      { label: "Sincronizaciones",     path: "/admin/portal-crm/marketing/sync-jobs",        icon: RefreshCw },
    ],
  },
  {
  ...
  },
  {
    ...
    items: [
      { label: "Pronóstico",            path: "/admin/portal-crm/revenue/forecast",    icon: LineChartIcon },
      { label: "Atribución de ingresos", path: "/admin/portal-crm/revenue/attribution", icon: GitBranch },
      { label: "Velocidad",             path: "/admin/portal-crm/revenue/velocity",    icon: Zap },
      { label: "Metas y cuotas",        path: "/admin/portal-crm/revenue/goals",       icon: Target },
    ],
  },
  {
    label: "Operación",
    items: [
      { label: "Constructor de campañas", path: "/admin/portal-crm/operations/builder",      icon: Wand2 },
      { label: "Copiloto IA",             path: "/admin/portal-crm/operations/copilot",      icon: Bot },
      { label: "Desarrollos",             path: "/admin/portal-crm/operations/developments", icon: Building2 },
    ],
  },
  {
    label: "Configuración",
    items: [
      { label: "Preparación de integraciones", path: "/admin/portal-crm/settings/connections",           icon: Plug },
      { label: "Preparación para despliegue",  path: "/admin/portal-crm/settings/deployment-readiness",  icon: ShieldCheck },
      { label: "Registros de API",             path: "/admin/portal-crm/settings/api-logs",              icon: FileClock },
      { label: "Checklist de integración",     path: "/admin/portal-crm/settings/integration-checklist", icon: ListChecks },
      { label: "Organización",                 path: "/admin/portal-crm/settings/organization",          icon: Settings },
      { label: "Usuarios y roles",             path: "/admin/portal-crm/settings/users",                 icon: UserCog },
      { label: "Administración de desarrollos", path: "/admin/portal-crm/settings/developments",        icon: Building2 },
      { label: "Administración de pipelines",  path: "/admin/portal-crm/settings/pipelines",            icon: Briefcase },
    ],
  },
];
