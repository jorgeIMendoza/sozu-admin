      ...
      <DialogContent className="max-w-md">
        <DialogHeader>
          <DialogTitle className="flex items-center gap-2">
            <RefreshCw className="h-4 w-4" /> Sincronizar comisionistas
          </DialogTitle>
          <DialogDescription>
            Esta acción dará de alta en cada canal al personal de <strong>Roles y Sueldos</strong> cuyo rol participa en comisión, agregando
        ...
        <div className="space-y-3">
          <div className="rounded-lg border bg-muted/40 px-3 py-2 text-xs flex items-center justify-between">
            <span className="text-muted-foreground">Comisionistas nuevos a agregar</span>
          ...
          {noChanges && (
            <div className="flex items-center gap-2 text-sm text-muted-foreground rounded-lg border px-3 py-4 justify-center">
              ...
              No hay comisionistas nuevos por agregar; todo está sincronizado.
            </div>
          )}
        </div>
