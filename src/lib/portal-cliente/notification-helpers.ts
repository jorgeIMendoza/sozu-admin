import type { PreReservation, OfertaComercial } from "@/lib/offer-data";
import type { Agent } from "@/lib/portal-cliente/agent-data";
import type { TemplateContext } from "@/lib/portal-cliente/notification-templates";
