    ...
    plans: [
      {
        title: "Plano de ubicación",
        type: "ubicacion",
        previewGradient: "from-violet-50 to-violet-100",
        level: "Nivel 7",
        model: "Modelo Parota +",
        totalArea: "72.74 m²",
      },
    ...
    specs: [
      {
        category: "Estructura",
        items: [
          "Sistema estructural de marcos de concreto con losas postensadas",
          "Muros divisorios de tablaroca con aislamiento acústico",
          "Cimentación profunda con pilas de fricción",
        ],
      },
      {
        category: "Muros",
        items: [
          "Interior: pasta con acabado liso, pintura vinílica blanco",
          "Baños: porcelanato gran formato 60×120 cm piso a techo",
          "Acento en sala: panel de madera de ingeniería",
        ],
      },
      {
        category: "Pisos",
        items: [
          "Áreas sociales: porcelanato rectificado 120×120 cm",
          "Recámaras: duela de ingeniería de roble europeo 14 mm",
          "Baños: porcelanato antiderrapante 60×60 cm",
          "Terraza: deck de WPC (madera compuesta)",
        ],
      },
      {
        category: "Carpintería",
        items: [
          "Puertas: madera sólida con herraje europeo",
          "Closets: vestidor walk-in con sistema modular premium",
          "Puerta principal: madera con cerradura electrónica",
        ],
      },
      {
        category: "Cocina",
        items: [
          "Cubierta de cuarzo Silestone blanco 3 cm de espesor",
          "Gabinetes de MDF lacado con sistema soft-close",
          "Tarja doble de acero inoxidable con grifería extractible",
          "Espacio para refrigerador y horno empotrado",
        ],
      },
      {
        category: "Aire acondicionado",
        items: [
          "Sistema VRF con condensadora centralizada",
          "Evaporadoras tipo cassette en sala y recámaras",
          "Control individual por zona con termostato digital",
        ],
      },
      {
        category: "Instalaciones",
        items: [
          "Eléctrica: cableado de cobre con tablero QO y protecciones termomagnéticas",
          "Hidráulica: sistema de presión constante con tubería PEX",
          "Gas: instalación oculta con detector de fuga",
          "Telecomunicaciones: cableado estructurado Cat 6A y fibra óptica",
          "Domótica: preparación para sistema de automatización",
        ],
      },
    ],
    inventory: [
      {
        category: "Mobiliario fijo",
        items: [
          { qty: 1, description: "Cocina integral con isla y barra", location: "Cocina" },
          { qty: 1, description: "Vestidor walk-in con cajones e iluminación LED", location: "Recámara principal" },
          { qty: 1, description: "Closet con interiores premium", location: "Recámara 2" },
          { qty: 2, description: "Mueble de baño doble con espejo retroiluminado", location: "Baños" },
        ],
      },
      {
        category: "Electrodomésticos",
        items: [
          { qty: 1, description: "Campana extractora de isla", location: "Cocina" },
          { qty: 1, description: "Calentador de paso 20 lts", location: "Área de servicio" },
          { qty: 1, description: "Centro de lavado (espacio y conexiones)", location: "Área de servicio" },
        ],
      },
      {
        category: "Accesorios",
        items: [
          { qty: 2, description: "Juego premium de accesorios de baño (acabado negro mate)", location: "Baños" },
          { qty: 1, description: "Tendedero eléctrico de techo", location: "Área de servicio" },
          { qty: 1, description: "Persianas blackout motorizadas", location: "Recámara principal" },
        ],
      },
      {
        category: "Blancos",
        items: [
          { qty: 2, description: "WC suspendido con sistema oculto de descarga", location: "Baños" },
          { qty: 2, description: "Lavabo de diseño sobre cubierta de piedra", location: "Baños" },
          { qty: 1, description: "Regadera tipo lluvia 30 cm con sistema termostático", location: "Baño principal" },
          { qty: 1, description: "Tina de hidromasaje independiente", location: "Baño principal" },
        ],
      },
    ],
  },
