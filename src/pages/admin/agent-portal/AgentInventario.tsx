...
import { ModalHeader } from "@/components/ui/form-standard";
    ...
    <>
        ...
        <div className="p-4">
          ...
          {canRead && (
            <div className="mt-4 flex items-center gap-2">
              ...
              {!isAgotado && (
                <Button variant="outline" className="flex-1" onClick={onViewUnits}>
                  <Building2 className="h-3.5 w-3.5" /> Inventario
                </Button>
              )}
              <Button
      ...
      <Dialog open={shareOpen} onOpenChange={setShareOpen}>
        <DialogContent className="max-w-sm gap-0 overflow-hidden p-0">
          <ModalHeader title={`Compartir - ${proyecto.nombre}`} />
