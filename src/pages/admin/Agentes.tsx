...
export default function Agentes() {
  ...
  const [selectedAgenteForBeneficiarios, setSelectedAgenteForBeneficiarios] = useState<Agente | null>(null);
  ...
  const filteredAgentes = agentes.filter(agente => 
    ...
    agente.curp?.toLowerCase().includes(searchTerm.toLowerCase()) ||
  ...
  const handleBeneficiarios = (agente: Agente) => {
    setSelectedAgenteForBeneficiarios(agente);
