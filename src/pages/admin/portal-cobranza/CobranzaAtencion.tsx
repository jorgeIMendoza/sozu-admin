          ...
          <div className="px-5 py-3 border-b border-border">
            <div className="flex items-center justify-between mb-2">
              ...
              <div className="flex items-center gap-1">
                <Button variant="ghost" size="icon" className="h-7 w-7" onClick={() => navigate(`/admin/portal-cobranza/cuenta/${selectedCase.accountId}`)} title="Ver expediente">
              ...
              <div className="px-5 py-4 space-y-5">
                ...
                <div>
                  ...
                  <div className="space-y-1.5">
                    {clientAccounts.slice(0, 3).map(({ account, role }) => (
                      <button key={account.id} onClick={() => navigate(`/admin/portal-cobranza/cuenta/${account.id}`)}
                ...
                <div>
                  ...
                  <div className="grid grid-cols-2 gap-1.5">
                    ...
                    <ActionBtn icon={Eye} label="Ver expediente" onClick={() => navigate(`/admin/portal-cobranza/cuenta/${selectedCase.accountId}`)} />
                  </div>
                </div>
              </div>
            )}
