                    ...
                    {activeTab === 'active' ? (
                      <>
                        ...
                        <Button
                          variant="ghost"
                          size="sm"
                          onClick={() => handleBeneficiarios(administrador)}
  ...
  return (
    <div className="container mx-auto py-6 px-4">
      ...
      <Dialog open={isBeneficiariosDialogOpen} onOpenChange={setIsBeneficiariosDialogOpen}>
        <DialogContent className="max-w-4xl max-h-[90vh] overflow-y-auto">
          <DialogHeader>
            <DialogTitle>Gestionar Beneficiarios - {selectedAdministradorForBeneficiarios?.nombre_legal}</DialogTitle>
          </DialogHeader>
          {selectedAdministradorForBeneficiarios && (
            <BeneficiariosForm
              personaId={selectedAdministradorForBeneficiarios.id}
              personaNombre={selectedAdministradorForBeneficiarios.nombre_legal}
            />
          )}
        </DialogContent>
      </Dialog>
