...
export default function PortalAdministracionPagosEjecutadosPage() {
  return (
    <>
      <PageHeader
        title="Pagos Ejecutados"
        description="Bitácora de pagos a externos y dispersiones internas ya ejecutadas por Administración"
