...
import {
  ...
  type TipoCuenta,
} from "@/hooks/usePortalSocioBancario/useHistoricoComercial";
import {
  useHistoricoComercialDetalle,
  type CategoriaHistorico,
  type HistoricoComercialDetalleRow,
} from "@/hooks/usePortalSocioBancario/useHistoricoComercialDetalle";
import {
  Sheet,
  SheetContent,
  SheetHeader,
...
import { useMetricasConversionComercial } from "@/hooks/usePortalSocioBancario/useMetricasConversionComercial";
...
export default function SocioBancarioHistoricoComercialPage() {
