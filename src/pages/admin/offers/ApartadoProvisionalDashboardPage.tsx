...
import ApartadoSummaryCard from "@/components/admin/offers/apartado-provisional/ApartadoSummaryCard";
import HoldCountdownCard from "@/components/admin/offers/apartado-provisional/HoldCountdownCard";
import CompletarApartadoButton from "@/components/admin/offers/apartado-provisional/CompletarApartadoButton";
import AsesorContactPanel from "@/components/admin/offers/apartado-provisional/AsesorContactPanel";
import ContratoPreliminarReadSection from "@/components/admin/offers/apartado-provisional/ContratoPreliminarReadSection";
import DocumentosRequeridosCard from "@/components/admin/offers/apartado-provisional/DocumentosRequeridosCard";
import ProvisionalNotificationsCard from "@/components/admin/offers/apartado-provisional/ProvisionalNotificationsCard";
import CancelarApartadoButton from "@/components/admin/offers/apartado-provisional/CancelarApartadoButton";
