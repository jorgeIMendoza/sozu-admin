...
export default function Duenos() {
  ...
  const [selectedDuenoForBeneficiarios, setSelectedDuenoForBeneficiarios] = useState<Dueno | null>(null);
  ...
  const handleBeneficiarios = (dueno: Dueno) => {
    setSelectedDuenoForBeneficiarios(dueno);
                    ...
                    {activeTab === 'active' ? (
                      <>
                        ...
                        <Button
                          variant="ghost"
                          size="sm"
                          onClick={() => handleBeneficiarios(dueno)}
  ...
  return (
    <div className="container mx-auto py-6 px-4">
      ...
      <Dialog open={isBeneficiariosDialogOpen} onOpenChange={setIsBeneficiariosDialogOpen}>
        <DialogContent className="max-w-4xl max-h-[90vh] overflow-y-auto">
          <DialogHeader>
            <DialogTitle>Gestionar Beneficiarios - {selectedDuenoForBeneficiarios?.nombre_legal}</DialogTitle>
          </DialogHeader>
          {selectedDuenoForBeneficiarios && (
            <BeneficiariosForm
              personaId={selectedDuenoForBeneficiarios.id}
              personaNombre={selectedDuenoForBeneficiarios.nombre_legal}
            />
          )}
        </DialogContent>
      </Dialog>
