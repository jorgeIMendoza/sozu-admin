...
const EMBAJADORES_HOST = getPortalHost("embajadores");

export default function RegistroEmbajador() {
  ...
  const registerMutation = useMutation({
    mutationFn: async () => {
      const { data, error } = await supabase.functions.invoke('registro-embajador-publico', {
        body: {
    ...
    return (
      <div className="login-page">
        ...
        <div className="login-card relative z-10 text-center">
          ...
          <a href={`${EMBAJADORES_HOST}/login`} className="block">
    ...
    <div className="login-page">
      ...
      <div className="login-card relative z-10">
        ...
        <p className="text-sm text-center mb-7" style={{ color: 'hsl(0 0% 45%)' }}>
          Completa tus datos para unirte al programa de referidos
        </p>
        ...
        <form onSubmit={handleSubmit} className="space-y-4">
          ...
          >
            {registerMutation.isPending ? "Registrando..." : "Registrarme como Embajador"}
          </button>
