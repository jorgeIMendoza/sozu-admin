...
export const VALID_ADMIN_ROUTES = new Set([
  ...
  '/admin/portal-tickets/todos',
  '/admin/portal-tickets/mis-tickets',
  '/admin/portal-tickets/sin-asignar',
  '/admin/portal-tickets/pipeline',
  '/admin/portal-tickets/configuracion/pipelines',
  '/admin/portal-tickets/configuracion/etapas',
  '/admin/portal-tickets/configuracion/categorias',
  '/admin/portal-tickets/configuracion/prioridades',
  '/admin/portal-tickets/configuracion/equipo',
  '/admin/portal-personal',
  '/admin/portal-personal/inventario',
  '/admin/portal-personal/inventario/:slug',
