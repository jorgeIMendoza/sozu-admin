-- Fix report ID 5: edificios_modelos is a junction table, need to join edificios for the name
UPDATE reportes
...
GROUP BY cc.id, o.id_producto, proy.nombre, edif.nombre, mod.nombre, prop.numero_propiedad, prod.nombre, per.nombre_legal, dueno_persona.nombre_legal, cc.precio_final, cc.fecha_compra, cc.clabe_stp, pagado.total_pagado
