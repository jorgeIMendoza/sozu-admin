-- Crear función que se ejecuta cuando un documento es verificado
...
-- Crear trigger que se ejecuta después de actualizar un documento
DROP TRIGGER IF EXISTS after_documento_verificado ON documentos;
CREATE TRIGGER after_documento_verificado
  ...
  EXECUTE FUNCTION trigger_check_escrituracion();