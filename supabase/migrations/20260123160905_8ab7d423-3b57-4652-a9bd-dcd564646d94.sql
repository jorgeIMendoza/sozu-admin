...
-- Recreate the function with the updated propietario logic
...
BEGIN
  ...
  WHERE cc.activo = p_activo
    ...
    AND (p_tipos IS NULL OR 
      CASE 
        WHEN o.id_producto_servicio IS NOT NULL THEN 'Producto'
  ...
  SELECT 
    ...
    cc.id_oferta,
    CASE 
      WHEN o.id_producto_servicio IS NOT NULL THEN 'Producto'::text
