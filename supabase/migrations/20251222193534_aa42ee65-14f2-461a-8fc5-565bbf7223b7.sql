-- Actualizar el query SQL del reporte para agregar numero_departamento e id_cuenta_cobranza
UPDATE reportes 
...
SELECT 
  ...
  ''CC'' || cc.id as id_cuenta_cobranza,
  ''Propiedad'' as tipo,
  NULL as categoria,
  NULL as producto,
  cc.precio_final,
...
SELECT 
  ...
  ''CCP'' || cc.id as id_cuenta_cobranza,
  ''Producto'' as tipo,
