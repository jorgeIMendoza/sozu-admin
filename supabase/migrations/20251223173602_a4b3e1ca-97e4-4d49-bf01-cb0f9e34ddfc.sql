-- Update the query_sql for "Solo resta pagos a contraentrega" report to have correct column order
-- fecha_pago_contraentrega should come right after fecha_compra
UPDATE reportes 
...
WHERE nombre = 'Solo resta pagos a contraentrega' AND activo = true;