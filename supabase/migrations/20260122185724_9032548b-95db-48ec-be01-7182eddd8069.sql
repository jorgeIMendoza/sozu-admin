-- First drop all overloaded versions of the function
...
DROP FUNCTION IF EXISTS public.get_cuentas_cobranza_paginadas(INTEGER, INTEGER, TEXT, TEXT, TEXT, TEXT, TEXT, TEXT, TEXT, INTEGER[], TEXT[], BOOLEAN, TEXT, INTEGER[], INTEGER[]);

-- Now recreate with correct logic (propiedades -> edificios_modelos -> proyectos)
