-- Drop and recreate with correct table name: estatus_disponibilidad (not estado_disponibilidad)
...
BEGIN
  ...
  LEFT JOIN estatus_disponibilidad ed ON cc.id_estatus_disponibilidad = ed.id
