...
-- =====================================================
-- FIX: Excluir cuentas de mantenimiento del listado de Cuentas de Cobranza
-- Las cuentas de mantenimiento tienen id_cuenta_cobranza_padre NOT NULL
-- =====================================================
...
BEGIN
  ...
  SELECT 
    ...
    -- Lógica de dueño: para productos con comprador o propiedades con mantenimiento activo, mostrar comprador
    (CASE 
