-- =====================================================
-- BACKUP: get_cuentas_cobranza_paginadas v20260127143438
-- =====================================================
-- Versión anterior guardada en comentario para referencia
-- Los cambios son:
-- 1. Lógica de dueño: mostrar comprador si restante <= 0 (en lugar de cuenta mantenimiento)
-- 2. apartado_pagado: calcular correctamente basándose en el primer acuerdo completado
-- =====================================================
...
BEGIN
  ...
  WHERE cc.activo = p_activo
    AND cc.id_cuenta_cobranza_padre IS NULL  -- EXCLUIR cuentas de mantenimiento
  ...
  -- CTE para verificar si el primer acuerdo de pago está completado (Apartado o Enganche)
  ...
  SELECT 
    ...
    -- Lógica de dueño: para productos/propiedades mostrar comprador si restante <= 0
    (CASE 
      -- Si es producto o propiedad, el restante es <= 0 y tiene comprador, mostrar comprador como dueño
    ...
    -- apartado_pagado: true si el primer acuerdo de pago está completado
...
-- =====================================================
-- BACKUP del RPC anterior (para referencia/rollback)
-- =====================================================
COMMENT ON FUNCTION public.get_cuentas_cobranza_paginadas IS 'v20260127-fix-dueno-restante-apartado-pagado
BACKUP versión anterior:
- Lógica dueno usaba cuenta mantenimiento activa
- apartado_pagado estaba hardcodeado a false
Cambios v20260127:
- dueno: mostrar comprador si restante <= 0
- apartado_pagado: true si primer acuerdo está completado';